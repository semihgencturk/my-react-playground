...
function FriendRow({ friend, isSelected, onSelect }: FriendRowProps) {
...
export function NonReactMemoExample() {
  ...
  return (
    <article className={styles.card}>
      <header className={styles.header}>
        <h3 className={styles.title}>Without React.memo every row re-renders</h3>
        <p className={styles.subtitle}>
          This version uses the same teammate list without memoization, so toggling
          theme or selecting rows causes the entire list to render again. Compare the
          render counters with the memoized example to spot the difference.
        </p>
      </header>

      <div className={styles.controls}>
        <label className={styles.controlGroup} htmlFor="non-memo-search">
